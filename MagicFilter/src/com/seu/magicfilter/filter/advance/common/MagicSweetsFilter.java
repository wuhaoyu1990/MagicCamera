...
public class MagicSweetsFilter extends GPUImageFilter{
	...
	public MagicSweetsFilter(Context context){
		super(NO_FILTER_VERTEX_SHADER,OpenGLUtils.readShaderFromRawResource(context, R.raw.sweets));
		mContext = context;
	}
	
	public void onDestroy(){
		super.onDestroy();
	    GLES20.glDeleteTextures(1, new int[]{mToneCurveTexture[0], mMaskGrey1TextureId}, 0);
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		        ...
		        mMaskGrey1TextureId = OpenGLUtils.loadTexture(mContext, "filter/rise_mask2.jpg");
		    }
	    });
	}
}

...
public class MagicSunsetFilter extends GPUImageFilter{
	...
	public MagicSunsetFilter(Context context){
		super(NO_FILTER_VERTEX_SHADER,OpenGLUtils.readShaderFromRawResource(context, R.raw.sunset));
		mContext = context;
	}
	
	public void onDestroy(){
		super.onDestroy();
	    GLES20.glDeleteTextures(1, new int[]{mToneCurveTexture[0], mMaskGrey1TextureId, mMaskGrey2TextureId}, 0);
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		        ...
		        mMaskGrey1TextureId = OpenGLUtils.loadTexture(mContext, "filter/rise_mask1.jpg");
		        mMaskGrey2TextureId = OpenGLUtils.loadTexture(mContext, "filter/rise_mask2.jpg");
		    }
	    });
	}
}
